...
;;;    )
  (if prspeang
    (setq pp (list (car pp) (- (cadr prspeang) 440) (caddr pp)))
    )
  (setvar "mirrtext" 0)
  (command "_mirror" "_C" (list (+ (car pp) 1500) (+ (cadr pp) 450)) (list (- (car pp) 2000) (+ (cadr pp) 2500 450)) "" "_non" pm_r "_non" (polar pm_r (/ pi 2) 1000) "_n")
